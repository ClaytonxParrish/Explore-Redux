...
const incrementCustonBtn = document.getElementById('increment-custom')
...
const changeCustom = () => {
store.dispatch({
  type: 'counter/custom',payload: (+customValue.value)
})
}
...
incrementCustonBtn.addEventListener('click', changeCustom)
